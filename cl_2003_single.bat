...
@set LIB=%MSVCDir%\ATLMFC\LIB;%MSVCDir%\LIB;%MSVCDir%\PlatformSDK\lib\prerelease;%MSVCDir%\PlatformSDK\lib;%FrameworkSDKDir%\lib;%LIB%
 ...
 "C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\bin\cl.exe"   /I d:\root\trunk\gtest /I D:\root\trunk\Baselib\ /D WINDOWSCODE   /nologo /incremental:no /debug /machine:I386  /SUBSYSTEM:windows %1%   version.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib msvcrt.lib  kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib 
@rem 
@echo "C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\bin\link.exe" *.obj 
@rem 
