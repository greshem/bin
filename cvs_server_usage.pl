...
#2011_03_02_11:37:46   星期三   add by greshem
1. f13 上默认会安装 cvs 并且 安装 /etc/xinetd.d/cvs
...
1. CVS 的验证数据库.  /home./cvsroot/CVSROOT/passwd 数据库里面的cvsroot 的用户， 需要注意. 
 注意  "cvsroot: no such system user" 这样的报错.  需要添加cvsroot 这样的用户. 
	useradd cvsroot
2. 
########################################################################
...
export CVSROOT=:pserver:q**************n@192.168.1.73:/home/cvsroot
##############
cvs login
