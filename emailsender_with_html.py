...
def main():
    ...
    parser.add_argument('--tls', dest='tls', action='store_true', help="Use TLS if specified")
    parser.add_argument("--reply-to", required=False, default=None, help="Reply-To field in email")
...
if __name__=="__main__":
    print """
    Usage: 
    python __main__.py   --debuglevel 4 --port 25  --host mail.emotibot.com.cn   --login greshem --password q******************************n   --to  greshem@emotibot.com --subject test    --text  text_info    --html htl_str     --sender    greshem@qq.com   
    """;
    main();
