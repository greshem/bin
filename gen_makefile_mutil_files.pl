...
__DATA__
################OPTION###################
CCOMPILE = gcc -Wno-write-strings
CPPCOMPILE = g++ -Wno-write-strings
COMPILEOPTION = -c -Wall -static -pthread -O -DNDEBUG -DLINUXCODE
#INCLUDEDIR = -I /root/QzjUnit/QzjUnit/
INCLUDEDIR = -I /root/trunk/Baselib/

LINK = g++
LINKOPTION = -o output -lpthread -ltermcap -lutil   -lgpm -ldl -lext2fs -lntfs
