...
~        
my $disk1=change_mobile_path_to_win_path('sdb1');
my $disk2=change_mobile_path_to_win_path('sdb2');
my $disk3=change_mobile_path_to_win_path('sdb3');
my $disk4=change_mobile_path_to_win_path('sdb4');
#print "\n";
#print "sdb1-> ".$disk1."\n";
...
sub save_file(@)
{
	...
	open(FILE, "> c:\\bin\\mobile_harddisk_skeletion.pl") or die("输出文件错误\n");
	print FILE<<EOF
#!/usr/bin/perl
\$pattern=shift;
foreach (<DATA>)
